...
function Setting(header, configure, start, signal, writeValue) {
...
module.exports = {
    ...
    "Magnetometer" : new Setting("x-axis (T),y-axis (T),z-axis (T)", (board, odr) => {
        MetaWear.mbl_mw_mag_bmm150_configure(board, 9, 15, MetaWear.MagBmm150Odr.enums[closest([10.0, 15.0, 20.0, 25.0], odr)].value);
    }, (board) => {
