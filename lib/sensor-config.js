...
function writeCartesianFloatType(data, state, name) {
    ...
    if ('metacloud' in state) {
        state['metacloud'].addData(name, [data.epoch, value.x, value.y, value.z]);
    }
...
module.exports = {
    ...
    "Gravity" : new SensorFusionSetting("x-axis (g),y-axis (g),z-axis (g)", MetaWear.SensorFusionData.GRAVITY, 
